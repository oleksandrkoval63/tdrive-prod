    ...
    (() => {
        ...
        function formRating() {
            ...
            function formRatingAction(e) {
                ...
                if (targetElement.closest(".rating__input")) {
                    ...
                    if (ratingSet) {
                        formRatingGet(rating, ratingValue);
                        rating.dataset.ratingValue = ratingValue;
                    }
                }
            }
            ...
            function formRatingSet(rating, value) {
                ...
                ratingItems.forEach(((ratingItem, index) => {
                    const input = ratingItem.querySelector(".rating__input");
                    input.checked = false;
        ...
        function initSliders() {
            if (document.querySelectorAll(".swiper")) {
                ...
                new swiper_core_Swiper(".similar__slider", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                if (subMenu) {
                    ...
                    if (activeBlock && activeBlock !== subMenu) activeBlock.classList.remove("_sub-menu-open");
                    targetElement.classList.toggle("_sub-menu-active");
                    subMenu.classList.toggle("_sub-menu-open");
                    document.documentElement.classList.toggle("sub-menu-open", subMenu.classList.contains("_sub-menu-open"));
                } else console.log("Ой ой, немає такого підменю :(");
                e.preventDefault();
            }
            if (targetElement.closest(".overlay")) {
                document.querySelectorAll("._sub-menu-active").forEach((el => el.classList.remove("_sub-menu-active")));
                document.querySelectorAll("._sub-menu-open").forEach((el => el.classList.remove("_sub-menu-open")));
            ...
            if (targetElement.closest(".sub-menu-catalog__back")) {
                ...
                if (openBlocks.length) {
                    ...
                    if (!document.querySelector("._sub-menu-open") && !document.querySelector(".open")) document.documentElement.classList.remove("sub-menu-open");
                }
                e.preventDefault();
            }
        }
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const mainCategories = document.querySelectorAll(".sub-menu-catalog__item");
            mainCategories.forEach((category => {
                const subMenu = category.querySelector("ul");
                if (subMenu && subMenu.children.length > 0) category.classList.add("has-subcategories"); else category.classList.remove("has-subcategories");
            }));
            const sidebarTitles = document.querySelectorAll(".catalog-sidebar-category .spollers__title");
            sidebarTitles.forEach((title => {
                const subMenu = title.nextElementSibling;
                if (subMenu && subMenu.tagName.toLowerCase() === "div" && subMenu.children.length > 0) title.classList.add("has-subcategories"); else title.classList.remove("has-subcategories");
            }));
        }));
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            const observer = new MutationObserver((function(mutations) {
                mutations.forEach((function(mutation) {
                    if (mutation.type === "attributes" && mutation.attributeName === "class") moveElements();
                }));
            }));
        ...
        document.querySelectorAll(".catalog-sidebar-category__close").forEach((closeBtn => {
            closeBtn.addEventListener("click", (function() {
                document.querySelectorAll(".catalog-sidebar-category.active").forEach((activeCategory => {
        ...
        $(document).mouseup((function(e) {
            ...
            if (e.target != popup[0] && popup.has(e.target).length === 0) $(".popup-overlay").fadeOut();
        }));
        ...
        $(document).mouseup((function(e) {
            ...
            if (e.target != popup[0] && popup.has(e.target).length === 0) $(".popup-afterform").fadeOut();
        }));
        $("#popup-phone").click((function() {
            $(".popup-afterform").fadeIn();
            $(".popup-overlay").fadeOut();
        }));
        function handlePopup(popupClass, buttonId) {
            $(buttonId).on("click", (function(e) {
                e.stopPropagation();
                $(".popup-reg, .popup-auth, .popup-recovery, .popup-sended, .popup-click, .popup-change").hide();
                $(popupClass).fadeIn();
            }));
            $(".close-popup").on("click", (function(e) {
                e.stopPropagation();
                $(this).closest(".popup-reg, .popup-auth, .popup-recovery, .popup-sended, .popup-click, .popup-change").hide();
            }));
            $(document).on("click", (function(e) {
                if (!$(e.target).closest(".popup-custom").length) $(".popup-reg, .popup-auth, .popup-recovery, .popup-sended, .popup-click, .popup-change").hide();
            }));
            $(".popup-custom").on("click", (function(e) {
                e.stopPropagation();
            }));
            $("#popup-success").on("click", (function(e) {
                e.stopPropagation();
                $(".popup-sended").hide();
            }));
        ...
        handlePopup(".popup-reg", "#auth");
        handlePopup(".popup-auth", "#popup-auth-btn");
        handlePopup(".popup-auth", "#popup-return");
        handlePopup(".popup-reg", "#reg-acc");
        handlePopup(".popup-recovery", "#pass-recovery");
        handlePopup(".popup-click", "#one-click");
        handlePopup(".popup-sended", "#popup-rec");
        handlePopup(".popup-change", "#change-pass");
        const showPasswordBtns = document.querySelectorAll("#show-action");
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const catalogList = document.querySelector(".catalog-page .spollers__item");
            if (catalogList) {
                catalogList.setAttribute("open", "");
                const firstChild = catalogList.firstElementChild;
                const lastChild = catalogList.lastElementChild;
                if (firstChild && lastChild) {
                    firstChild.classList.add("_spoller-active");
                    lastChild.removeAttribute("hidden", "");
                }
            }
        }));
        document.addEventListener("DOMContentLoaded", (function() {
            const selectSortBtn = document.querySelector(".delivery-page .select__title");
            selectSortBtn.setAttribute("data-title", "Сортировка");
        }));
        function liqPayCards() {
            const liqPayBtns = document.querySelectorAll(".booking-delivery-block");
            liqPayBtns.forEach((btn => {
                btn.addEventListener("click", (() => {
                    liqPayBtns.forEach((otherBtn => {
        ...
        document.addEventListener("DOMContentLoaded", liqPayCards);
        window["FLS"] = true;
        menuInit();
        spollers();
        tabs();
